...
//    const numDays = document.querySelector('input[placeholder="3"]').value;
//    const numPeople = document.querySelector('input[type="number"]:nth-of-type(2)').value;
//    const hikeType = document.querySelector('select').value; 
//    const allergies = document.querySelector('input[type="text"]').value;
...
//    fetch('https://localhost:7013/ResultFirst', {
//        method: 'POST',
//        headers: {
...
//        .then(data => {
//            console.log(data); // обработка результата
//        })
//        .catch((error) => {
